-- The package extract_hr_data_pkg contains procedures that will extract HR schema data and
-- insert the data into extract tables. It also contains a private procedure that displays
-- extract information for each extract procedure.
...
CREATE OR REPLACE PACKAGE extract_hr_data_pkg AS
...
END extract_hr_data_pkg;
/

CREATE OR REPLACE PACKAGE BODY extract_hr_data_pkg AS
...
EXECUTE extract_hr_data_pkg.a01_regions_extract_proc();
EXECUTE extract_hr_data_pkg.a02_countries_extract_proc();
EXECUTE extract_hr_data_pkg.a03_locations_extract_proc();
EXECUTE extract_hr_data_pkg.a04_departments_extract_proc();
EXECUTE extract_hr_data_pkg.a05_jobs_extract_proc();
EXECUTE extract_hr_data_pkg.a06_job_history_extract_proc();
EXECUTE extract_hr_data_pkg.a07_employees_extract_proc();
